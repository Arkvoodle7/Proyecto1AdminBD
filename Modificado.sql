...
GO
ALTER PROCEDURE [dbo].[SP_UptadeProducto] (@IdProducto INT ,@IdProvedor INT, @Nombre VARCHAR(100), @Categoria VARCHAR(20), @Precio DECIMAL(10, 2), @Tiempo_Entrega INT, @Stock Decimal(10, 2))
AS
BEGIN
    ...
    SET id_proveedor = @IdProvedor,nombre = @Nombre,categoria = @Categoria,
		precio = @Precio,tiempo_Entrega = @Tiempo_Entrega, StockDisponible = @Stock
			WHERE id_producto = @IdProducto;
END;

GO
ALTER PROCEDURE [dbo].[SP_InsertProducto] (@IdProvedor INT, @Nombre VARCHAR(100), @Categoria VARCHAR(20), @Precio DECIMAL(10, 2), @Tiempo_Entrega INT, @Stock Decimal(10, 2))
AS
BEGIN
...
GO
CREATE PROCEDURE sp_ObtenerPedidosPorProveedor
    @id_proveedor INT
AS
BEGIN
