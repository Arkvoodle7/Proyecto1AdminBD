<%@ Page Title="Agregar Oferente" Language="C#" MasterPageFile="~/Paginas/Pagina.Master" AutoEventWireup="true" CodeBehind="AgregarOferente.aspx.cs" Inherits="Proyecto1AdminBD.Paginas.AgregarOferente" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container-fluid px-4">
        <h1 class="mt-4">Agregar Oferente</h1>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <asp:Panel ID="PanelAgregarOferente" runat="server">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="txtGeografia" class="form-label">Geografía (latitud,longitud)</label>
                        <asp:TextBox ID="txtGeografia" runat="server" CssClass="form-control" style="max-width: 300px;" placeholder="Ej: 40.7128,-74.0060"></asp:TextBox>
                    </div>
                    <asp:Button ID="btnAgregar" runat="server" Text="Agregar Oferente" CssClass="btn btn-primary" OnClick="btnAgregar_Click" />
